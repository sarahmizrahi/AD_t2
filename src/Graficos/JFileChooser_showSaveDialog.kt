...
class Ventana8 : JFrame() {

    //showSaveDialog(). Permite seleccionar el guardar archivos
...
fun main(args: Array<String>) {
    EventQueue.invokeLater {    //Buena practica para asegurar que se crea y se ve la ventana
        Ventana8().isVisible = true  //Crea instancia de la clase Ventana y la hace visible con true
    }
}